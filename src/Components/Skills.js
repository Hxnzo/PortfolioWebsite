    ...
    return (
        <div className='bg-black pb-10 px-10 pt-[50px]' name='skills'>
            ...
            <div className='p-5 justify-center m-auto max-w-[960px] bg-black text-black rounded-lg'>
                <div className='m-auto p-5 grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-5'>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[80px]' src={htmlPic} alt="/" />
                        <h1 className='flex justify-center'>HTML5</h1>
                    </div>   
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[70px]' src={cssPic} alt="/" />
                        <h1 className='flex justify-center'>CSS3</h1>
                    </div>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[75px]' src={javaPic} alt="/" />
                        <h1 className='flex justify-center'>Java</h1>
                    </div>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[70px]' src={javascriptPic} alt="/" />
                        <h1 className='flex justify-center'>Javascrip</h1>
                    </div>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[80px]' src={reactPic} alt="/" />
                        <h1 className='flex justify-center'>React</h1>
                    </div>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[70px]' src={pythonPic} alt="/" />
                        <h1 className='flex justify-center'>Python</h1>
                    </div>
                </div>
                <div className='m-auto p-5 grid lg:grid-cols-6 md:grid-cols-3 sm:grid-cols-2 gap-5'>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[70px]' src={mysqlPic} alt="/" />
                        <h1 className='flex justify-center'>MySQL</h1>
                    </div>
                    <div className='inline p-3 px-5 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[55px]' src={djangoPic} alt="/" />
                        <h1 className='flex justify-center'>Django</h1>
                    </div>
                    <div className='inline p-3  py-6 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[75px]' src={tailwindPic} alt="/" />
                        <h1 className='flex justify-center'>Tailwind</h1>
                    </div>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[70px]' src={angularPic} alt="/" />
                        <h1 className='flex justify-center'>Angular</h1>
                    </div>
                    <div className='inline p-3 py-4 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[80px]' src={scssPic} alt="/" />
                        <h1 className='flex justify-center'>SCSS</h1>
                    </div>
                    <div className='inline p-3 justify-center m-auto bg-white hover:bg-black text-black hover:text-white rounded-3xl border-solid border-4 border-[#00FFB9]'>
                        <img className='w-[70px]' src={vuePic} alt="/" />
