...
const Contact = () => {
    return (
        <div className='bg-black pb-10 px-10 h-screen pt-[350px]' name='contacts'>
            <div className='m-auto text-[50px] justify-center text-center overflow-hidden before:h-[1px] after:h-[1px] text-white
            ...
            <div className='p-5 m-auto max-w-[650px] bg-black'>
                <div className='m-auto p-10 grid smd:grid-cols-4 grid-cols-2'>
                    ...
                    <div className='inline-block p-2 mb-5 m-auto shadow-md shadow-[#00FFB9]'>
                        <a href="https://github.com/Hxnzo" className='mx-auto'>
                            <AiOutlineGithub size={ 60 } className='text-white' />
                        </a>
                    </div>
                    <div className='inline-block p-2 mb-5 m-auto shadow-md shadow-[#00FFB9]'>
                        <a href="https://www.linkedin.com/in/hanzalah-patel/" className='mx-auto'>
